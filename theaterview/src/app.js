var tileLength = 30, border = 1, radius = 100, loaded = {}, css3dWidget;
var progressManager, entryPanorama, moviePanorama, panoramaAreaTTHL, viewer, videoWall, SOUND_OVER, SOUND_CLICK;

var categories = [
	{ id: 28, size: '2x1', position: { x: -3.0, y: 0.5 }, name: "1" },
	{ id: 12, size: '2x1', position: { x: -3.0, y: -0.5 }, name: "2" },
	{ id: 35, size: '2x1', position: { x: -1.0, y: 0.5 }, name: "3" },
	{ id: 14, size: '2x1', position: { x: -1.0, y: -0.5 }, name: "4" },
	{ id: 878, size: '2x1', position: { x: 1.0, y: 0.5 }, name: "5" },
	{ id: 10770, size: '2x1', position: { x: 1.0, y: -0.5 }, name: "6" },
	{ id: 80, size: '2x2', position: { x: 3.0, y: 0.0 }, name: "7" }
];
...
function init() {
	...
	panoramaAreaTTHL.add(entryPanorama)
	viewer.add(panoramaAreaTTHL, moviePanorama);
...
function generateProgressManager() {
	var manager = {}, animationEndEvents, launchElement, maskElement, loadingElement, enterElement, ytElements, progressTextElement;
...
function getEntryPanorama() {
	var panorama, tiles, shadeHeight, menu_classified;
	shadeHeight = 5;
	...
	menu_classified = generateMenuItem('OVERVIEW', 360, 28, 6, tiles);
	menu_classified.position.set(0, tiles.position.y + 36, tiles.position.z);
...
function getMoviePanorama() {
	...
	title.add(poster, backButton, release);
